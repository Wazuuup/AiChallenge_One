...
const val NEWS_API_SERVER_PORT = 8085
const val NEWS_API_SERVER_SSL_PORT = 8444
...
fun main() {
    ...
    val sslPort = try {
        ...
        NEWS_API_SERVER_SSL_PORT
    }

    val keystoreFile = File("mcp-newsapi/src/main/resources/keystore.jks")
    val keyAlias = System.getenv("SSL_KEY_ALIAS") ?: "newsapiserver"
    ...
    println("Starting NewsAPI MCP Server...")
    println("HTTP:  http://localhost:$NEWS_API_SERVER_PORT")
