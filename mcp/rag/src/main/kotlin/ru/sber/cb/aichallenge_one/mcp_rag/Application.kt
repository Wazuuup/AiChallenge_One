...
const val RAG_MCP_PORT = 8092
const val RAG_MCP_SSL_PORT = 8448
...
fun main() {
    ...
    val keystoreFile = File("mcp/rag/src/main/resources/keystore.jks")
    val keyAlias = System.getenv("SSL_KEY_ALIAS") ?: "ragserver"
    ...
    println("Starting RAG MCP Server...")
    println("HTTP:  http://localhost:$RAG_MCP_PORT")
