...
import ru.sber.cb.aichallenge_one.mcp_tickets.database.DatabaseFactory
import java.io.File
import java.io.FileInputStream
import java.io.FileOutputStream
import java.security.KeyStore

const val TICKETS_MCP_PORT = 8096
const val TICKETS_MCP_SSL_PORT = 8452
...
fun main() {
    ...
    val sslPort = try {
        ...
        TICKETS_MCP_SSL_PORT
    }

    val keystoreFile = File("mcp/tickets/src/main/resources/keystore.jks")
    val keyAlias = System.getenv("SSL_KEY_ALIAS") ?: "ticketsserver"
    ...
    println("Starting Tickets MCP Server...")
    println("HTTP:  http://localhost:$TICKETS_MCP_PORT")
