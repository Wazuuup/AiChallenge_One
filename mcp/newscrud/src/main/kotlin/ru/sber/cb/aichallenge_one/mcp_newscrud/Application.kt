...
const val NEWS_CRUD_MCP_PORT = 8086
const val NEWS_CRUD_MCP_SSL_PORT = 8445
...
fun main() {
    ...
    val sslPort = try {
        ...
        NEWS_CRUD_MCP_SSL_PORT
    }

    val keystoreFile = File("mcp-newscrud/src/main/resources/keystore.jks")
    val keyAlias = System.getenv("SSL_KEY_ALIAS") ?: "newscrudserver"
    ...
    println("Starting News CRUD MCP Server...")
    println("HTTP:  http://localhost:$NEWS_CRUD_MCP_PORT")
