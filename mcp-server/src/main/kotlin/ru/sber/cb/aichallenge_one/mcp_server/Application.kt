...
const val MCP_SERVER_SSL_PORT = 8443
...
fun main() {
    ...
    val keyAlias = System.getenv("SSL_KEY_ALIAS") ?: "mcpserver"
    ...
    println("HTTP:  http://localhost:$MCP_SERVER_PORT")
...
private fun generateSelfSignedCertificate(
    ...
    val keyStore = buildKeyStore {
        certificate(keyAlias) {
            ...
            // Include localhost, IPs, and actual server hostname
            domains = listOf(
